...
CREATE TABLE `cart` (
  ...
  `cart_status` varchar(255) NOT NULL COMMENT '購物車狀態(1未結帳; 2出貨中; 3已完成)'
...
(1, 1, '2021-12-29 09:47:01', 12000, 10, 10, '1'),
...
(1, 'b12345', '56789', '鳩施施', '好施', '銅', 1000, 0, 200, '0923-234-789', '新北市中和區', 'hua_lee2@testmail.com.tw', '1989-10-30', '', 1, '1111222233334444', '', 0, '2021-12-28 17:28:49'),
...
(10, 1, 5, 'cuso', '肉壽司', '', '實惠，量多', '2021-12-24', '肉的分量很夠', 2, '5,7', '1');
...
--
ALTER TABLE `share_item`
  MODIFY `share_item_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '分享牆物件id', AUTO_INCREMENT=11;
