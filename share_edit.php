    ...
    <div class="col-lg-6">
      <div class="card my-5">
        <div class="card-body py-4">
          <h5 class="card-title">編輯你的食物分享</h5>

          <form name="form1" onsubmit="sendData(); return false;">
            <input type="hidden" name="share_id" id="item-id" value="<?= $row['share_item_id'] ?>">
            <div class="mb-3">
...
imgsDiv.addEventListener('click', function(e) {
  ...
  if (t.classList.contains('del')) {
    ...
    fetch('share_edit_remove_api.php', {
        method: 'POST',
        body: fd,
      }).then(r => r.json())
      .then(obj => {
